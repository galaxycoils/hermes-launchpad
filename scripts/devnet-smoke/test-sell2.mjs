...
// Sell smaller amount - 10000 tokens (10000 * 1e6 = 10 billion raw units)
const tokIn = 10000 * 1000000;
...
console.log('Sell quote:', { tokIn: tokInRaw.toString(), solOut: solOut.toString(), solOutSOL: Number(solOut) / 1e9 });
