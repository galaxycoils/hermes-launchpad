...
console.log('Curve state:', { virtualSolReserves, virtualTokenReserves });
...
console.log('Buy quote:', { solInLamports: solInLamports.toString(), tokOut: tokOut.toString(), minOut: minOut.toString() });

// Buy
const buyIx = buildTradeIx('buy', payer.publicKey, mint, solInLamports, minOut, FEE_WALLET, payer.publicKey);
